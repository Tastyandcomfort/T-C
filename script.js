...
async function submitUserMessage() {
  ...
  try {
    ...
    if (lowerMsg.includes('hour') || lowerMsg.includes('time')) {
      ...
      fallbackResponse = "We are currently not located on earth but in soon we will. Please check out the 'You Are Here' tab to get direct navigation views on our live interactive map!";
